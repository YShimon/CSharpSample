...
namespace T4
{
    ...
    public partial class RuntimeTextTemplate : RuntimeTextTemplateBase
    {
        ...
        {
            this.Write("// <auto-generaged>\r\n// このファイルへの変更は、正しくない動作の原因になる可能性があり、\r\n// コードが再生成されると失われます。\r\n/" +
                    "/ </auto-generated>\r\nnamespace ");
            this.Write(this.ToStringHelper.ToStringWithCulture(Context.Namespace));
            this.Write("\r\n{\r\n");
 foreach(var i in Enumerable.Range(0, Context.Count)) { 
            this.Write("    public class T4");
            this.Write(this.ToStringHelper.ToStringWithCulture(Context.Suffix));
